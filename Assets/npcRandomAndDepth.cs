...
public class npcRandomAndDepth : MonoBehaviour {
    ...
    void newLayers(){
        ...
        rendHairBack.sortingOrder = (Mathf.RoundToInt(transform.position.y * -100));
        ...
        rendHandL.sortingOrder = (Mathf.RoundToInt(transform.position.y * -100)) + 2;
        rendHandR.sortingOrder = (Mathf.RoundToInt(transform.position.y * -100)) + 2;
    }
